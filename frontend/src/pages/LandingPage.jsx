      ...
      <div className="landing">
        ...
        <section className="text-center px-6 py-24 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/login">
              <button className="px-8 py-3 rounded-xl font-semibold text-sm border-2 border-slate-200 text-slate-700  hover:bg-slate-700 hover:text-slate-200 transition">
                Login
              </button>
            </a>
          </div>
